...
class Pet:
    ...
    def __init__(self, nome, especie, idade, peso, nome_dono, vacinado, data_nascimento, altura, hospedado=False):
        self.nome = nome
    ...
    def exibir_dados(self):
        ...
        print(f"Data de Nascimento: {self.data_nascimento}") # Novo print
        print(f"Peso: {self.peso} kg")
        print(f"Altura: {self.altura} cm") # Novo print
...
def cadastrar_pet(lista_pets):
    ...
    pet = Pet(nome, especie, idade, peso, nome_dono, vacinado, data_nascimento, altura)
    lista_pets.append(pet)
